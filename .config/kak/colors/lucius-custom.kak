...
# and markup
face global title ${lucius_light_blue}+b
face global header ${lucius_light_green}+b
...
face global MenuForeground ${lucius_darker_grey},${lucius_lighter_grey}
face global MenuBackground ${lucius_lighter_grey},${lucius_grey}
